...
ok
127.0.0.1:6379[5]> incr age  #自增1
(integer) 31
127.0.0.1:6379[5]> incrby age 10  #自增10
(integer) 41
...
"sbjs"
127.0.0.1:6379[5]> getrange name 0 -1 #按字符串长度截取
"sbjs"
...
# key不存在则设置（set if not exist）,存在则设置失败(分布式锁中使用)
...
127.0.0.1:6379> msetnx a1 valll a3 val3 #a1已经存在，a3不存在，设置失败(原子性操作，要么一起成功，要么一起失败)
(integer) 0
