...
(integer) 1
127.0.0.1:6379> rpush list memcache #放到列表尾部
(integer) 2
127.0.0.1:6379> lpush list mysql sqlite #添加多个
(integer) 3


# 取得队列元素
127.0.0.1:6379> lrange list 0 -1 #start_pos stop_pos
1) "mysql"
2) "mongo"
3) "redis"
...
1) "mongo"
2) "redis"
127.0.0.1:6379> lrem list 2 redis #移除列表中值为redis的值，移除2个
(integer) 1
127.0.0.1:6379> lrange list 0 -1
1) "mongo"
...
3) "redis"
4) "mongo"
127.0.0.1:6379> ltrim list 1 2 #修剪,只保留指定区域内的数据 key start stop
OK
127.0.0.1:6379> lrange list 0 -1
1) "mysql"
2) "redis"
